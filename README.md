...
![logo](https://github.com/byte4geek/mainetwork-scanner/raw/main/mainetwork-scanner_logo.png)
...
1.  **Clone the Repository:**
    ```bash
    git clone git clone https://github.com/byte4geek/mainetwork-scanner.git
